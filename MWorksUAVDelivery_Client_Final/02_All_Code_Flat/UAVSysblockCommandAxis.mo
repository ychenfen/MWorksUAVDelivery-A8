model UAVSysblockCommandAxis
  ...
  SysplorerEmbeddedCoder.Port.Inport cmd_in 
    annotation (Placement(transformation(origin = {-180, 36}, extent = {{-10, -10}, {10, 10}}),
      iconTransformation(origin = {-101.8, 0}, extent = {{-1.8, -1.8}, {1.8, 1.8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D0")=0)));
  ...
  block AxisSubSystem
    SysplorerEmbeddedCoder.Port.Inport u 
      annotation (Placement(transformation(origin = {-158, -0.845782}, extent = {{-10, -10}, {10, 10}}),
        iconTransformation(origin = {-301.8, 0}, extent = {{-1.8, -1.8}, {1.8, 1.8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D0")=0)));
